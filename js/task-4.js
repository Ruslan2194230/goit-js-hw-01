...
let numberOfOrderedDroids;
let totalPrice = 0;

let orderField = prompt("Какое кол-во хотите приобрести?");

if (orderField === null) {
  console.log("Отменено пользователем");
} else {
  numberOfOrderedDroids = Number(orderField);
  totalPrice = numberOfOrderedDroids * pricePerDroid;
  ...
  if (totalPrice > credits) {
    ...
    console.log(
      ` Вы купили ${numberOfOrderedDroids} дроидов, на счету осталось ${credits} кредитов. `
    );
  }
}
